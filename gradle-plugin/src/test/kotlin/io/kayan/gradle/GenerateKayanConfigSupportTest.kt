...
class GenerateKayanConfigSupportTest {
    ...
    @Test
    fun resolveTargetDeclarationNullabilityMarksOptionalKeysNullableWhenOneGeneratedTargetIsMissingThem() {
        val brandName = ConfigDefinition(
            jsonKey = "brand_name",
            propertyName = "BRAND_NAME",
            kind = ConfigValueKind.STRING,
        ...
        assertEquals(true, declarationNullability.getValue(brandName))
    }
