...
Kayan is a small, opinionated Kotlin Gradle plugin for layered JSON config.
...
1. You write JSON config files with a `flavors` object for environment-specific values
