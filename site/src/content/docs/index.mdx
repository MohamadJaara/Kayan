...
template: splash
hero:
  tagline: Kayan merges base config with optional overrides and generates typed Kotlin values. Shared code reads config directly without platform-specific wiring.
  image:
